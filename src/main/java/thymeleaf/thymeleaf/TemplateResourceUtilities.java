...
final class TemplateResourceUtils {
	...
	static String cleanPath(final String path) {
		...
		// Some shortcuts, just in case this is empty or simply has no '.' or '..' (and
		// no double-/ we should simplify)
		...
		// We will traverse path in reverse order, looking for '.' and '..' tokens and
		// processing them
